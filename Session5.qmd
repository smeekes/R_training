...
1.  [Regression Analysis](#reg1)
2.  [Bonus: Creating your own functions](#ownfunc)
3.  [Bonus: Flow Control](#flowcontrol)
4.  [Bonus: Tidyverse](#dataman2)
5.  [Concluding Remarks](#conclude)
...
assuming the `Final_Score` variable was added to the grades data set:
...
## Exercise 5.3: Create your own function
...
## Exercise 5.4: Create your own function
...
## Exercise 5.4: Conditional Execution
...
## Exercise 5.5: Impute Missing Values
